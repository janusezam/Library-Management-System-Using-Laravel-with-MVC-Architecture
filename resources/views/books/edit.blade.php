    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-6 mb-10">
            ...
            <div>
                ...
                <p class="text-slate-500 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Update asset specifications</p>
            </div>
        </div>

        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            <form action="{{ route('books.update', $book) }}" method="POST" class="p-10">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input type="number" id="published_year" name="published_year" value="{{ old('published_year', $book->published_year) }}" min="1000" max="9999"
                    ...
                    <div class="md:col-span-2 space-y-4">
                        ...
                        <select id="authors" name="authors[]" multiple required
                            ...
                            @foreach ($authors as $author)
                                <option value="{{ $author->id }}" @selected(in_array($author->id, old('authors', $book->authors->pluck('id')->toArray()))) class="py-2">{{ $author->name }}</option>
                            @endforeach
                        </select>
