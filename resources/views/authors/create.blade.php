...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-6 mb-10">
            ...
            <div>
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Onboard Creative</h1>
                <p class="text-slate-500 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Initialize new contributor profile</p>
            </div>
        </div>

        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            <form action="{{ route('authors.store') }}" method="POST" class="p-10">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <!-- Bio -->
                    <div>
                        <label for="bio" class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1">Professional Bio</label>
                        <textarea id="bio" name="bio" rows="6"
                                  ...
                                  placeholder="Write a short summary of the author’s background and work.">{{ old('bio') }}</textarea>
                ...
                <div class="mt-12 flex gap-4">
                    ...
                    <button type="submit" 
                            class="flex-[2] py-4 bg-slate-900 hover:bg-emerald-600 text-white font-black uppercase tracking-widest text-[10px] rounded-2xl shadow-xl shadow-slate-200 transition-all duration-300">
                        Create Profile
                    </button>
                </div>
            </form>
